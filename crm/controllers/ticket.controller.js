 ...
 */
 ...
 const sendNotificationReq = require("../utils/notificationClient")//1 august 
  ...
  * also updated
  *     
  * 4.send the email after the ticket is created to all the stake holders  1 august
  */
 ...
 exports.createTicket = async (req, res) => {
     ...
     try {
         ...
         if (ticketCreated) {
              ...
              */
             sendNotificationReq(`Ticket created with id : ${ticketCreated._id}`,"Customer complaint ticket logged",`${customer.email},${engineer,email},deepanshuthakur791@gmail.com`,"CRM APP")//1 AUGUST
