...
/**
 * Normal structure of writing test
 */
...
test("Testing object", ()=>{
    ...
    //Assertion for the object create
    expect(data).toEqual({two:2, one:1}); // for object to make use of this only
    // expect(data).toBe({two:2, one:1})
})

/**
 * Using the method not.toBe
 */
